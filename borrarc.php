...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['Id_Operador'])) {
    ...
    $delete_query = "DELETE FROM operadores WHERE Id_Operador = $Id_Operador";
    if (mysqli_query($con, $delete_query)) {
        echo "<p>Operador con ID $Id_Operador eliminado exitosamente.</p>";
    } else {
        echo "<p>Error al eliminar el operador: " . mysqli_error($con) . "</p>";
    }
}

$resultado = mysqli_query($con, "SELECT * FROM operadores");
...
while ($row = mysqli_fetch_array($resultado)) {
    ...
    echo "<td>
        <form method='POST'>
            <input type='hidden' name='Id_Operador' value='" . $row['Id_Operador'] . "'>
